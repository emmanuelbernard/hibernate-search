...
import org.hibernate.search.spatial.impl.SpatialQueryBuilderPointImpl;
...
public abstract class SpatialQueryBuilder {
	...
	public static Query buildGridQuery(double latitude, double longitude, double radius, String fieldName) {
		return SpatialQueryBuilderPointImpl.buildGridQuery( Point.fromDegrees( latitude, longitude ), radius, fieldName);
	}
	...
	public static Query buildDistanceQuery(double latitude, double longitude, double radius, String fieldName) {
		return SpatialQueryBuilderPointImpl.buildDistanceQuery( Point.fromDegrees( latitude, longitude ), radius, fieldName );
	}
	...
	public static Query buildSpatialQuery(double latitude, double longitude, double radius, String fieldName) {
		return SpatialQueryBuilderPointImpl.buildSpatialQuery( Point.fromDegrees( latitude, longitude), radius, fieldName );
	}
}
